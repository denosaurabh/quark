...
export default function NFtUploadBridge(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(
    'models/world/user/upload_bridge_com.glb'
  ) as GLTFResult

  const load = useLoad(({ chunkData }) => chunkData('user-bridge-end').load)
  if (!load) return null
  ...
  return (
    ...
    >
      <mesh
        geometry={nodes['user-upload-bridge'].geometry}
